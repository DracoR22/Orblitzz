    ...
    <>
       <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
         <div className="w-[30%] blur-[120px] rounded-full h-32 absolute bg-brand-primaryBlue/50 -z-10 top-22"/>
            <SubTitleSection title="Automate social media visibility" subheading="Orblitzz saves you the effort of manually searching for and replying to social media posts to advertise your product."/>
